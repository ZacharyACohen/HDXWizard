...
3) Install Packages - Right click on HDXWizard folder and click "Copy as path". Open the command prompt (windows) or terminal (mac). Type in: **cd _ _copied_path_ _** , and click enter. Paste **pip install -r requirements.txt** and click enter again
